...
@Component
public class PayasyougoPaymentMethodImpl implements PaymentMethod<PaymentRequestDTO> {

    private final Logger log = LoggerFactory.getLogger(PayasyougoPaymentMethodImpl.class);

    private final RestTemplate restTemplate;
    private final ApplicationProperties applicationProperties;

    public PayasyougoPaymentMethodImpl(RestTemplate restTemplate, ApplicationProperties applicationProperties) {
    ...
    public Map pay(PaymentRequestDTO paymentRequest) {
        log.info("Start Payasyougo PaymentMethod");
        ...
        if(paymentUrl != null) {
            ...
            paymentResponse = restTemplate.postForEntity(paymentUrl, requestEntity, Map.class).getBody();
        }
        log.info("Payment response: {}", paymentResponse);
        log.info("End Payasyougo PaymentMethod");
